...
[AuxVariables]
  ...
  [./MultiAuxVariables]
    ...
    op_num = '2 2 1'             #First two should be equal to standard op_num
  [../]
  #[./free_energy]
  #  order = CONSTANT
  #  family = MONOMIAL
...
[Kernels]
  ...
  [./CH_parsed]
    ...
    w = mew
    kappa_name = kappa_c
    args = 'gr0 gr1'     #Must be changed as op_num changes
  [../]
  [./CH_rigidbody]
    type = MultiGrainRigidBodyMotion
    variable = mew
    c = rho
    v = 'gr0 gr1'        #Must be changed as op_num changes
  [../]
[]
...
[AuxKernels]
  ...
  [./MatVecRealGradAuxKernel]
    ...
    op_num = '2 2'               #Should both be equal to standard op_num
...
[UserObjects]
  [./grain_center]
    ...
    etas = 'gr0 gr1'     #Must be changed as op_num changes
...
[Materials]
  ...
  [./free_energy]
    ...
    args = 'rho gr0 gr1' #Must be changed as op_num changes
